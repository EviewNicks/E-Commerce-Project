...
<!-- 
<div
class="flex h-[64px] min-h-[64px] px-[10px] flex-col justify-center max-w-screen-xl items-center gap-[10px] flex-shrink-0 self-stretch rounded-t-[80px] bg-Primary-Colors-4"></div> -->
                        ...
                        <div class="icon-container absolute flex left-0 top-0 ">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    fill="url(#pattern-accesories-1)" stroke="#95A5A6" stroke-width="1" />
                                <defs>
                                    <pattern id="pattern-accesories-1" patternContentUnits="objectBoundingBox" width="1"
                                        height="1">
                                        <use xlink:href="#accesories-1"
                                            transform="matrix(0.00147929 0 0 0.0011557 0 -0.193995)" />
                                    </pattern>
                                    <image id="accesories-1" width="676" height="1201"
                                        xlink:href="/public/Accesories/cap-2.jpg" />
                                </defs>
                            </svg>
                    ...
                    <div
                        ...
                        <div class="icon-container absolute flex left-0 top-0 ">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M80.8415 5.5C76.4137 1.94045 70.903 0 65.2219 0H32C14.3269 0 0 14.3269 0 32V224C0 241.673 14.3269 256 32 256H168C185.673 256 200 241.673 200 224V32C200 14.3269 185.673 0 168 0H133.778C128.097 0 122.586 1.94045 118.159 5.5V5.5C113.731 9.05955 108.22 11 102.539 11H96.4611C90.7799 11 85.2692 9.05955 80.8415 5.5V5.5Z"
                                    fill="url(#pattern-accesories-2)" stroke="#95A5A6" stroke-width="1" />
                                <defs>
                                    <pattern id="pattern-accesories-2" patternContentUnits="objectBoundingBox" width="1"
                                        height="1">
                                        <use xlink:href="#accesories-2"
                                            transform="matrix(0.00147929 0 0 0.0011557 0 -0.193995)" />
                                    </pattern>
                                    <image id="accesories-2" width="676" height="1201"
                                        xlink:href="/public/Accesories/cap.jpg" />
                                </defs>
                            </svg>
                    ...
                    <div
                        ...
                        <div class="icon-container absolute flex left-0 top-0 ">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M80.8415 5.5C76.4137 1.94045 70.903 0 65.2219 0H32C14.3269 0 0 14.3269 0 32V224C0 241.673 14.3269 256 32 256H168C185.673 256 200 241.673 200 224V32C200 14.3269 185.673 0 168 0H133.778C128.097 0 122.586 1.94045 118.159 5.5V5.5C113.731 9.05955 108.22 11 102.539 11H96.4611C90.7799 11 85.2692 9.05955 80.8415 5.5V5.5Z"
                                    fill="url(#pattern-accesories-3)" stroke="#95A5A6" stroke-width="1" />
                                <defs>
                                    <pattern id="pattern-accesories-3" patternContentUnits="objectBoundingBox" width="1"
                                        height="1">
                                        <use xlink:href="#accesories-3"
                                            transform="matrix(0.00147929 0 0 0.0011557 0 -0.193995)" />
                                    </pattern>
                                    <image id="accesories-3" width="676" height="1201"
                                        xlink:href="/public/Accesories/glassbe.jpg" />
                                </defs>
                            </svg>
                    ...
                    <div
                        ...
                        <div class="icon-container absolute flex left-0 top-0 ">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M80.8415 5.5C76.4137 1.94045 70.903 0 65.2219 0H32C14.3269 0 0 14.3269 0 32V224C0 241.673 14.3269 256 32 256H168C185.673 256 200 241.673 200 224V32C200 14.3269 185.673 0 168 0H133.778C128.097 0 122.586 1.94045 118.159 5.5V5.5C113.731 9.05955 108.22 11 102.539 11H96.4611C90.7799 11 85.2692 9.05955 80.8415 5.5V5.5Z"
                                    fill="url(#pattern-accesories-4)" stroke="#95A5A6" stroke-width="1" />
                                <defs>
                                    <pattern id="pattern-accesories-4" patternContentUnits="objectBoundingBox" width="1"
                                        height="1">
                                        <use xlink:href="#accesories-4"
                                            transform="matrix(0.00147929 0 0 0.0011557 0 -0.193995)" />
                                    </pattern>
                                    <image id="accesories-4" width="676" height="1201"
                                        xlink:href="/public/Accesories/glassbe-2.jpg" />
                                </defs>
                            </svg>
                    ...
                    <div
                        ...
                        <div class="icon-container absolute flex left-0 top-0 ">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M80.8415 5.5C76.4137 1.94045 70.903 0 65.2219 0H32C14.3269 0 0 14.3269 0 32V224C0 241.673 14.3269 256 32 256H168C185.673 256 200 241.673 200 224V32C200 14.3269 185.673 0 168 0H133.778C128.097 0 122.586 1.94045 118.159 5.5V5.5C113.731 9.05955 108.22 11 102.539 11H96.4611C90.7799 11 85.2692 9.05955 80.8415 5.5V5.5Z"
                                    fill="url(#pattern-accesories-5)" stroke="#95A5A6" stroke-width="1" />
                                <defs>
                                    <pattern id="pattern-accesories-5" patternContentUnits="objectBoundingBox" width="1"
                                        height="1">
                                        <use xlink:href="#accesories-5"
                                            transform="matrix(0.00147929 0 0 0.0011557 0 -0.193995)" />
                                    </pattern>
                                    <image id="accesories-5" width="676" height="1201"
                                        xlink:href="/public/Accesories/ring.jpg" />
                                </defs>
                            </svg>
