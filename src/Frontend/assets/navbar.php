<nav class="fixed mt-4 px-4 inset-x-0 z-50 flex max-w-[926px] mx-auto justify-between items-center py-2 rounded-full bg-primary text-white bg-Primary-Colors-4">
