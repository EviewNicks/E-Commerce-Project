            ...
            <div class="flex flex-col items-start self-stretch">
                ...
                <div class="title-recommend flex pb-8 justify-between items-center self-stretch">
                    <div class="flex p-[8px_0px] max-w-[300px] justify-center items-center flex-1 rounded-xl bg-white">
                        <span class="text-Primary font-poppins text-headline-medium">Formal Stylish</span>
                    </div>
                    <button type="button"
                ...
                <!-- Box Content -->
                <div class="box-content flex items-center gap-2 self-stretch">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                ...
                                <defs>
                                    ...
                                    <image id="image0_83_1388" width="676" height="1201"
                                        xlink:href="/public/Outfit/outfit-3.jpg" />
                                </defs>
                            </svg>
