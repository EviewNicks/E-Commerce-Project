...
<div class="col-span-12 flex flex-col items-center justify-end flex-shrink-0 pt-[88px]">
    <!-- Main Image -->
    <div
        class="main-image bg-grad-primarygrid bg-cover bg-center flex flex-col items-center gap-[10px] px-[80px] py-[21px] flex-1 self-stretch">
        <!-- Content Container -->
        <div
            class="content-container flex flex-col justify-between items-center flex-1 self-stretch rounded-[24px] min-h-[686px]">

            <!-- Title Recommend -->
            <div class="title-recommend flex py-0 px-12 justify-between items-center self-stretch">
                <div class="flex py-4 px-6 items-center rounded-xl bg-white">
                    <span class="text-Primary font-poppins text-headline-medium">Pilihan Terbaik Bulan ini</span>
                </div>
                <button type="button"
                    class="all flex py-1 pr-[4px] max-h-12 pl-6 gap-24 items-center justify-center rounded-full bg-Primary-Colors-4 cursor-pointer transition-all duration-300 ease-linear hover:bg-gradient-to-br hover:from-[#35526f] hover:to-[#2e4860] hover:border-[#e74c3c] hover:text-[#e74c3c] hover:-translate-y-0.5 hover:shadow-lg active:bg-[#2e4860] active:translate-y-0 active:shadow-md">
            ...
            <!-- Box Content -->
            <div class="box-content flex items-end gap-2 self-stretch relative">

                <div class="absolute flex p-[100px_12px_0px_12px] top-0 right-0 items-center z-10">
                    <div class="flex items-center">
                        <!-- Chevron Right -->
                        <div
                            class="flex items-center p-2 rounded-full bg-Secondary shadow-custom cursor-pointer transition-all duration-300 hover:bg-[#c0392b] hover:shadow-[0_8px_16px_rgba(0,0,0,0.3)] hover:scale-105 active:scale-95 active:shadow-[0_4px_8px_rgba(0,0,0,0.2)]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36"
                                fill="none">
                                <path
                                    d="M21.9002 30C22.5002 30 23.1002 29.7 23.4002 29.4C24.3002 28.5 24.3002 27 23.4002 26.1L15.3002 18L23.4002 9.90005C24.3002 9.00005 24.3002 7.50005 23.4002 6.60005C22.5002 5.70005 21.0002 5.70005 20.1002 6.60005L10.2002 16.2C9.30019 17.1 9.30019 18.6 10.2002 19.5L20.1002 29.1C20.7002 29.7 21.3002 30 21.9002 30Z"
                                    fill="#ECF0F1" />
                            </svg>
                        </div>

                        <div class="flex w-[229px] p-[10px] justify-center items-center">
                            <h4 class="text-black font-quicksand text-headline-small">SHOW OUTFIT</h4>
                        </div>
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36"
                                fill="none">
                                <path
                                    d="M14.0998 30C13.4998 30 12.8998 29.7001 12.5998 29.4C11.6998 28.5 11.6998 27 12.5998 26.1L20.6998 18L12.5998 9.90005C11.6998 9.00005 11.6998 7.50005 12.5998 6.60005C13.4998 5.70005 14.9998 5.70005 15.8998 6.60005L25.7998 16.2C26.6998 17.1 26.6998 18.6 25.7998 19.5L15.8998 29.1C15.2998 29.7 14.6998 30 14.0998 30Z"
                                    fill="#ECF0F1" />
                            </svg>
                        </div>
                    </div>
                ...
                <!-- Card Pertama -->
                <div
                    class="card-product relative group flex w-[364px] h-[518px] py-6 px-[22px] pb-3 flex-col justify-between items-center rounded-3xl hover:cursor-pointer active:scale-95 active:shadow-inner transition-all duration-300 ease-in-out">

                    <!-- object Container -->
                    <div class="icon-container absolute flex right-0 top-0">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="364" height="518" viewBox="0 0 364 518" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            <defs>
                                ...
                                <image id="image0_242_514" width="676" height="1201"
                                    xlink:href="<?= asset_url("/public/Outfit/outfit-3.jpg") ?> " />
                            </defs>
                        </svg>
                    ...
                    <div
                        ...
                        <div class="flex p-2 flex-col items-start">
                            <div
                                class="flex p-2 items-center self-stretch rounded-[12px] bg-white shadow-custom gap-2">
                                <!-- Rating -->
                                <div
                                    class="rating flex pr-[12px] items-center border-r-[2px] border-[#95A5A6] gap-1">
                        ...
                        <div class="icons-container flex flex-col items-start gap-[12px]">
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-[24px] h-[22px]"
                                    viewBox="0 0 16 14">
                                    <path
                    ...
                    <div
                        ...
                        <!-- object Container -->
                        <div class="icon-container absolute flex right-0 top-0">
                            <object data="/src/assets/svg/large-product-conatiner.svg"
                        ...
                        <div
                            ...
                            <object data="/src/assets/icon/chevron-right.svg" width="24" height="24"
                                type="image/svg+xml"></object>
                        </div>
                ...
                <!-- Card Kedua -->
                <div
                    class="relative card-product flex w-[200px] h-[256px] pt-4 px-3 pb-3 flex-col justify-between items-center rounded-3xl bg-[url(/public/Outfit/outfit-7.jpg')] bg-lightgray bg-center bg-cover bg-no-repeat">

                    <!-- object Container -->
                    <div class="icon-container absolute flex left-0 top-0 ">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="200" height="256" viewBox="0 0 200 256" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                d="M80.8415 5.5C76.4137 1.94045 70.903 0 65.2219 0H32C14.3269 0 0 14.3269 0 32V224C0 241.673 14.3269 256 32 256H168C185.673 256 200 241.673 200 224V32C200 14.3269 185.673 0 168 0H133.778C128.097 0 122.586 1.94045 118.159 5.5V5.5C113.731 9.05955 108.22 11 102.539 11H96.4611C90.7799 11 85.2692 9.05955 80.8415 5.5V5.5Z"
                                fill="url(#pattern0_83_1388)" stroke="#95A5A6" stroke-width="2" />
                            <defs>
                                <pattern id="pattern0_83_1388" patternContentUnits="objectBoundingBox" width="1"
                                    height="1">
                                    <use xlink:href="#image0_83_1388"
                                        transform="matrix(0.00147929 0 0 0.0011557 0 -0.193995)" />
                                </pattern>
                                <image id="image0_83_1388" width="676" height="1201"
                                    xlink:href="<?= asset_url("/public/Outfit/outfit-3.jpg") ?> " />
                            </defs>
                        </svg>

                        <!-- xlink:href="/public/Outfit/outfit-7.jpg" /> -->
                    </div>

                    <!-- rating, data Terjual bag and like product -->
                    <div class="rating-and-sales flex justify-between items-start self-stretch z-10">
                        <!-- Rating Container -->
                        <div class="flex p-[0_4px] flex-col items-start gap-[6px]">
                            <div class="flex p-[2px_4px] items-center gap-1 self-stretch rounded-[8px] bg-white">
                                <!-- Rating -->
                    ...
                    <!-- Promo and Title Container -->
                    <div
                        class="relative flex h-[96px] p-[32px_20px_8px_20px] flex-col justify-between items-center flex-shrink-0 self-stretch rounded-[24px] drop-shadow-shadow-product ">
                        <!-- Promo Text Container -->
                        <div class="flex p-[6px_0_0_8px] items-start flex-col absolute left-0 top-0 z-10">
                            <div class=" flex p-[0_8px] flex-col items-start rounded-[4px] bg-Secondary">
                                <p class="self-stretch text-white font-quicksand text-body-medium">
                                    Promo Hari ini!</p>
                            </div>
                        </div>
                        ...
                        <h4 class="self-stretch text-black font-quicksand text-body-small z-10">
                            Product Title Product Title Product Title Product Title </h4>
                        <div class="flex items-center justify-between self-stretch z-10">
                            <p class="text-black font-poppins text-body-small">Rp
                                800.000</p>
                            <div class="flex p-[0_2px] justify-center items-center rounded-[4px] bg-Secondary">
                                <p class="text-white font-poppins text-body-small">Stok
                                    Terbatas</p>
